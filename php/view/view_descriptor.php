...
class ViewDescriptor {
    ...
    /**
     * File che include la definizione HTML della riga di stato in alto (parte dello header)
     * @var string 
     */
    private $above_file;
    ...
    /**
     * Restituisce il path al file che include la definizione 
     * HTML della riga di stato in alto (parte dello header)
     * @return string
     */
    public function getAboveFile() {
        return $this->above_file;
    }

    /**
     * Imposta il file che include la definizione
     * HTML della riga di stato in alto (parte dello header)
     * @param $aboveFile il path al file contentente il logo
     */
    public function setAboveFile($aboveFile) {
        $this->above_file = $aboveFile;
    }
     ...
     * @param type $rightBar
     */
    public function setSideBarFile($rightBar) {
        $this->sideBar_file = $rightBar;
    }
